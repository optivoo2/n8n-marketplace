...
export class DocumentValidator {
     ...
     */
    async validateVoterID(voterIdInput) {
        try {
            ...
            if (isValid) {
                ...
                const formatted = cleanID.replace(/^(\d{4})(\d{4})(\d{4})$/, '$1 $2 $3');
                return {
                    valid: true,
                    formatted,
                    unformatted: cleanID,

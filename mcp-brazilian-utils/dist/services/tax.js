...
export class TaxCalculator {
     ...
     */
    async calculateIncomeTax(monthlyIncome, dependents = 0) {
        try {
     ...
     */
    async calculateINSS(salary, type = 'employee') {
        try {
     ...
     */
    async calculateVacation(salary, days = 30, sellDays = 0) {
        try {
            const salaryDecimal = new Decimal(salary);
     ...
     */
    async calculate13thSalary(salary, monthsWorked = 12) {
        try {
            const salaryDecimal = new Decimal(salary);
